...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='billetcoin.conf'
CONFIGFOLDER='/root/.billetcoin'
COIN_DAEMON='billetcoind'
COIN_CLI='billetcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/billetcoin/blt/releases/download/1.0.2.1/billetcoin-v1.0.2.1-daemon-linux.tar.gz'
